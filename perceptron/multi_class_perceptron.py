...
if __name__ == '__main__':
    ...
    def y_0_1(x): return w_0_1[0] / -w_0_1[1] * x + w_0_1[2] / -w_0_1[1]

    def y_1_2(x): return w_1_2[0] / -w_1_2[1] * x + w_1_2[2] / -w_1_2[1]

    def y_2_0(x): return w_2_0[0] / -w_2_0[1] * x + w_2_0[2] / -w_2_0[1]
